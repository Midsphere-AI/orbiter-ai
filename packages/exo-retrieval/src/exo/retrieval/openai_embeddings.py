"""OpenAI embeddings — re-exported from the canonical exo.models layer.
...
from exo.models.embeddings import OpenAIEmbeddings  # pyright: ignore[reportMissingImports]
